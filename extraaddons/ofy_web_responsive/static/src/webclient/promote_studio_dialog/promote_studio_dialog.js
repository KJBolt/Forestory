...
PromoteStudioDialog.template = "ofy_web_responsive.PromoteStudioDialog";
PromoteStudioDialog.components = { Dialog };

export class PromoteStudioAutomationDialog extends PromoteStudioDialog {}
PromoteStudioAutomationDialog.template = "ofy_web_responsive.PromoteStudioAutomationDialog";
